...
const VirtualPiano: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-0 left-[10%] w-32 h-16 bg-white/5 rounded-full blur-xl"></div>
      ...
      <div className="absolute bottom-[30%] right-[25%] w-48 h-32 bg-blue-500/5 rounded-full blur-3xl"></div>
